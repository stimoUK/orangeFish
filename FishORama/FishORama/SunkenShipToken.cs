...
namespace FishORama
{
    ...
    /// </summary>
    /// 
    class SunkenShipToken : X2DToken
    {
        #region Data members
        ...
        private AquariumMind mMind;       // Explicit reference to the mind the token is using to enact its behaviors.
        ...
        public SunkenShipToken(String pTokenName, AquariumToken pAquarium)
            : base(pTokenName)
        {
        ...
        protected override void DefaultProperties()
        {
            ...
            this.GraphicProperties.AssetID = "SunkenShipVisuals";
