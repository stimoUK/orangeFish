...
namespace FishORama
{
    ...
    class PiranhaToken : X2DToken
    {
        ...
        public PiranhaToken(String pTokenName, AquariumToken pAquarium)
            : base(pTokenName)
        {
        ...
        protected override void DefaultProperties()
        {
            ...
            this.GraphicProperties.AssetID = "PiranhaVisuals2";// this chooses the red piranha as the default visual.
