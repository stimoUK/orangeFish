...
namespace FishORama
{
    ...
    /// </summary>
    /// 
    class ToxicBarrelToken : X2DToken
    {
        #region Data Members
        ...
        private ToxicBarrelMind mMind;       // Explicit reference to the mind the token is using to enact its behaviors.
        #endregion
        ...
        public ToxicBarrelToken(String pTokenName, AquariumToken pAquarium)
            : base(pTokenName)
        {
        ...
        protected override void DefaultProperties()
        {
            ...
            this.GraphicProperties.AssetID = "ToxicBarrelVisuals";

            ToxicBarrelMind myMind = new ToxicBarrelMind(this);
