...
namespace FishORama
{
    ...
    class AquariumToken : X2DToken
    {
        ...
        //reference to the toxic barrel
        private MarkerToken mMarker = null;
        private ToxicBarrelToken tToxicBarrel = null;// wanted to remove but used teleport yPos instead.
        ...
        /// <summary>
        /// Get/set reference to marker barrel.
        /// </summary>
        public MarkerToken Marker
        {
            get { return mMarker; }
            set { mMarker = value; }
        }
        ...
        /// <summary>
        /// Get/set reference to toxic barrel.
        /// </summary>
        public ToxicBarrelToken ToxicBarrel
        {
            get { return tToxicBarrel; }
            set { tToxicBarrel = value; }
        }
        ...
        {
            this.mKernel.Scene.Remove(mMarker);
            mMarker = null;
        }
        public void RemoveToxicBarrel()
        {
            this.mKernel.Scene.Remove(tToxicBarrel);
            tToxicBarrel = null;
        }
