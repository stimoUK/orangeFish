...
namespace FishORama
{
    ...
    class SeaHorseToken : X2DToken
    {
        ...
        public SeaHorseToken(String pTokenName, AquariumToken pAquarium)
            : base(pTokenName)
        {
        ...
        protected override void DefaultProperties()
        {
            ...
            this.GraphicProperties.AssetID = "SeaHorseVisuals";// this chooses the red piranha as the default visual.
